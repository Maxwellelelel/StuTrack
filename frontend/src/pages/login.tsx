    ...
    return (
        <div className="w-screen h-screen bg-gray-100 flex justify-center items-center font-customFont">
            <div className="w-[22rem] h-[32rem] bg-white shadow-2xl rounded-[12px] font-customFont">
                ...
                <Link to="/register" className="py-[1.5rem] ml-[7rem] w-fit cursor-pointer hover:text-black transition duration-200 ease-in-out text-customGrey text-lg flex items-center justify-center">Create Account</Link>
            </div>
        </div>
    );
}
